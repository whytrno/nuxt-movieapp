<template>
  <div class="">
    ...
    <div class="flex mx-5 xl:mx-64 lg:mx-32 md:mx-14 my-5 sm:mt-8">
      ...
      <button v-show="searchInput !== ''" class="bg-orange-500 py-2 px-3 w-min whitespace-nowrap h-10 rounded-r-lg font-semibold text-white" @click="clearSearch">Clear Search</button>
    </div>
